...
## About this project
A personal 'Ask-Me' AI assistant page you build by prompting Claude.ai.
**Primary way to do it:** Claude.ai chat (build it as an Artifact / HTML page) — **no API key needed.**
...
- It's the **Ask-Me AI Assistant** hands-on. Static HTML pages — no runtime LLM, no API key.
